...
var Slider = (function ($) {
    ...
    var module = {
        ...
        early: function () {
            ...
            slider.append(self.pager());//append control dot

            for (i = 0, l = self.max; i < l; i += 1) {
                // self.items(i + 1).insertBefore($('.slider-nav .next').parents('li'));
                self.items(i + 1).appendTo($('.slider-nav'));
            }

            slider.append(self.nav_ico());//append nav control
        ...
        events: function () {
            ...
            slider.on('click', '.control-nav a', function (e) {
                e.preventDefault();
        ...
        nav_ico: function () {
            var ico = $('<ul class="control-nav"><li><a href="#" class="control-ele prev">Prev</a></li><li><a href="#" class="control-ele next">Next</a></li></ul>');
            return ico;
        },

        pager: function () {
            var nav = $('<ul class="slider-nav"></ul>');
            return nav;
        },
        items: function (i) {
